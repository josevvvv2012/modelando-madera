...
public class TipoFigura2 extends Composite {
	...
	public String getArchivoGaleria() {
		return cg.sDirectorio+"/"+cg.getGaleria(archivoID)+cg.ext;
	}
	public int getZ() {
